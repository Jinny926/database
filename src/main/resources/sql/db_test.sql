...
insert into major values('m8','앵귤러','아차차');

desc student;

insert into student values ('s1','최원빈','20100101','M','01010101010','m1');
...
insert into student(student_code,name,gender,major_code, birth, phone) values('s12','정오빈','M','m3','20030202','01000000000');
...
INSERT INTO STUDENT(student_code, name, gender, major_code, birth, phone) VALUES('s14', '김동현', 'M', 'm4', '20030202', '01000000020'),
                                                                                ('s15', '박은진', 'F', 'm3', '20221101', '01010101010');
...
insert into student values('s0', '안될애','20202020','M','01029292929','m1');
...
# 학교홈 vs 쿠팡
# "조치원읍 210번길 213-2"
# "조치원읍", "201번길", "213", "2" addr1, addr2, street, unit, postalcode